...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_alice_split_bs(
        KC_END,    KC_TRNS,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,            KC_F7,   KC_F8,   KC_F9,   KC_F10,     KC_F11,    KC_F12,     KC_TRNS,    KC_PSCR, 
        KC_INS,    KC_TRNS,   KC_TRNS, KC_VOLU, KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,   KC_TRNS,    KC_TRNS,    RESET, 
        KC_PGUP,   KC_TRNS,   KC_MPRV, KC_VOLD, KC_MNXT, KC_TRNS, KC_TRNS,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,    KC_TRNS,   KC_TRNS,                KC_TRNS, 
                   KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, BL_STEP,                   BL_TOGG, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_APP, 
